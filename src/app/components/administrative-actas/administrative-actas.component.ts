...
@Component({
  ...
  templateUrl: './administrative-actas.component.html',
  styleUrls: ['./administrative-actas.component.scss'],
  standalone: true,
  imports: [],
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class AdministrativeActasComponent  implements OnInit {
