...
import { checkmarkSharp, notificationsOutline, timeOutline, exitOutline, chevronForwardSharp, chevronBackOutline,removeOutline, personOutline, giftOutline, logOutOutline } from 'ionicons/icons';
